...
public class DiscordCommandsFactory {
    ...
    public static ApplicationCommandRequest createMeCommand(DiscordClient client, AppConfig config) {
        ApplicationCommandRequest greetMeRequest = ApplicationCommandRequest.builder()
                .name("me")
    ...
    @SuppressWarnings("checkstyle:MissingJavadocMethod")
    public static ApplicationCommandRequest createStatusCommand(DiscordClient client, AppConfig config) {
        ApplicationCommandRequest greetStatusRequest = ApplicationCommandRequest.builder()
                .name("status")
    ...
    @SuppressWarnings("checkstyle:MissingJavadocMethod")
    public static ApplicationCommandRequest createUpdateTeamsCommand(DiscordClient client, AppConfig config) {
        ApplicationCommandRequest updateTeamsCommandRequest = ApplicationCommandRequest.builder()
                .name("update_teams")
                .description("Send team names to pantheon over portal")
                .build();
        client.getApplicationService()
                .createGlobalApplicationCommand(config.getDiscord().getApplicationId(), updateTeamsCommandRequest)
                .block();
        return updateTeamsCommandRequest;
    }

    @SuppressWarnings("checkstyle:MissingJavadocMethod")
    public static ApplicationCommandRequest createAddPenaltyGameCommand(DiscordClient client, AppConfig config) {
        ApplicationCommandRequest addPenaltyGameCommandRequest = ApplicationCommandRequest.builder()
                .name("add_penalty_game")
                .description("Send penalty game to pantheon over portal")
                .build();
        client.getApplicationService()
                .createGlobalApplicationCommand(config.getDiscord().getApplicationId(), addPenaltyGameCommandRequest)
                .block();
